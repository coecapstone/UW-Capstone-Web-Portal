...
class EngineUI {
    ...
    static removeAddress() { return window.sessionStorage.removeItem(SESSION_KEY_ADDRESS); }
    static removeAirfare() { return window.sessionStorage.removeItem(SESSION_KEY_AIRFARE); }
    static removeAirfare_file() { return window.sessionStorage.removeItem(SESSION_KEY_AIRFARE_FILE); }
    static removeAmount() { return window.sessionStorage.removeItem(SESSION_KEY_AMOUNT); }
    static removeBirthday() { return window.sessionStorage.removeItem(SESSION_KEY_BIRTHDAY); }
    static removeBudget1() { return window.sessionStorage.removeItem(SESSION_KEY_BUDGET1); }
    static removeBudget2() { return window.sessionStorage.removeItem(SESSION_KEY_BUDGET2); }
    static removeBudget_length() { return window.sessionStorage.removeItem(SESSION_KEY_BUDGET_LENGTH); }
    static removeCar() { return window.sessionStorage.removeItem(SESSION_KEY_CAR); }
    static removeCar_file() { return window.sessionStorage.removeItem(SESSION_KEY_CAR_FILE); }
    static removeCarRental() { return window.sessionStorage.removeItem(SESSION_KEY_CARRENTAL); }
    static removeDate() { return window.sessionStorage.removeItem(SESSION_KEY_DATE); }
    static removeDeparture() { return window.sessionStorage.removeItem(SESSION_KEY_DEPARTURE); }
    static removeDestionation() { return window.sessionStorage.removeItem(SESSION_KEY_DESTIONATION); }
    static removeEmail() { return window.sessionStorage.removeItem(SESSION_KEY_EMAIL); }
    static removeFirstname() { return window.sessionStorage.removeItem(SESSION_KEY_FIRSTNAME); }
    static removeFlight() { return window.sessionStorage.removeItem(SESSION_KEY_FLIGHT); }
    static removeFlight_amount() { return window.sessionStorage.removeItem(SESSION_KEY_FLIGHT_AMOUNT); }
    static removeFlight_company() { return window.sessionStorage.removeItem(SESSION_KEY_FLIGHT_COMPANY); }
    static removeFlight_departdate() { return window.sessionStorage.removeItem(SESSION_KEY_FLIGHT_DEPARTDATE); }
    static removeFlight_from() { return window.sessionStorage.removeItem(SESSION_KEY_FLIGHT_FROM); }
    static removeFlight_number() { return window.sessionStorage.removeItem(SESSION_KEY_FLIGHT_NUMBER); }
    static removeFlight_reference() { return window.sessionStorage.removeItem(SESSION_KEY_FLIGHT_REFERENCE); }
    static removeFlight_returndate() { return window.sessionStorage.removeItem(SESSION_KEY_FLIGHT_RETURNDATE); }
    static removeFlight_to() { return window.sessionStorage.removeItem(SESSION_KEY_FLIGHT_TO); }
    static removeForMyself() { return window.sessionStorage.removeItem(SESSION_KEY_FORMYSELF); }
    static removeHotel() { return window.sessionStorage.removeItem(SESSION_KEY_HOTEL); }
    static removeHotel_address() { return window.sessionStorage.removeItem(SESSION_KEY_HOTEL_ADDRESS); }
    static removeHotel_amount() { return window.sessionStorage.removeItem(SESSION_KEY_HOTEL_AMOUNT); }
    static removeHotelFee() { return window.sessionStorage.removeItem(SESSION_KEY_HOTELFEE); }
    static removeHotel_file() { return window.sessionStorage.removeItem(SESSION_KEY_HOTEL_FILE); }
    static removeHotel_link() { return window.sessionStorage.removeItem(SESSION_KEY_HOTEL_LINK); }
    static removeHotel_movein() { return window.sessionStorage.removeItem(SESSION_KEY_HOTEL_MOVEIN); }
    static removeHotel_moveout() { return window.sessionStorage.removeItem(SESSION_KEY_HOTEL_MOVEOUT); }
    static removeHotel_name() { return window.sessionStorage.removeItem(SESSION_KEY_HOTEL_NAME); }
    static removeHotel_note() { return window.sessionStorage.removeItem(SESSION_KEY_HOTEL_NOTE); }
    static removeHotel_num() { return window.sessionStorage.removeItem(SESSION_KEY_HOTEL_NUM); }
    static removeHotel_zip() { return window.sessionStorage.removeItem(SESSION_KEY_HOTEL_ZIP); }
    static removeId() { return window.sessionStorage.removeItem(SESSION_KEY_ID); }
    static removeInfomation() { return window.sessionStorage.removeItem(SESSION_KEY_INFOMATION); }
    static removeLastname() { return window.sessionStorage.removeItem(SESSION_KEY_LASTNAME); }
    static removeMeal() { return window.sessionStorage.removeItem(SESSION_KEY_MEAL); }
    static removeMeal_amount() { return window.sessionStorage.removeItem(SESSION_KEY_MEAL_AMOUNT); }
    static removeMealProvided() { return window.sessionStorage.removeItem(SESSION_KEY_MEALPROVIDED); }
    static removeName() { return window.sessionStorage.removeItem(SESSION_KEY_NAME); }
    static removeNote() { return window.sessionStorage.removeItem(SESSION_KEY_NOTE); }
    static removeOrderId() { return window.sessionStorage.removeItem(SESSION_KEY_ORDERID); }
    static removePassport_file() { return window.sessionStorage.removeItem(SESSION_KEY_PASSPORT_FILE); }
    static removePersonalTravel() { return window.sessionStorage.removeItem(SESSION_KEY_PERSONALTRAVEL); }
    static removePersonalTravelDetails() { return window.sessionStorage.removeItem(SESSION_KEY_PERSONALTRAVELDETAILS); }
    static removeProfile_pic_url() { return window.sessionStorage.removeItem(SESSION_KEY_PROFILE_PIC_URL); }
    static removePurpose() { return window.sessionStorage.removeItem(SESSION_KEY_PURPOSE); }
    static removeReason() { return window.sessionStorage.removeItem(SESSION_KEY_REASON); }
    static removeReferenceNumber() { return window.sessionStorage.removeItem(SESSION_KEY_REFERENCENUMBER); }
    static removeRegistration() { return window.sessionStorage.removeItem(SESSION_KEY_REGISTRATION); }
    static removeRegistration_file() { return window.sessionStorage.removeItem(SESSION_KEY_REGISTRATION_FILE); }
    static removeRental_file() { return window.sessionStorage.removeItem(SESSION_KEY_RENTAL_FILE); }
    static removeRequestID() { return window.sessionStorage.removeItem(SESSION_KEY_REQUESTID); }
    static removeRequestType() { return window.sessionStorage.removeItem(SESSION_KEY_REQUESTTYPE); }
    static removeReturndate() { return window.sessionStorage.removeItem(SESSION_KEY_RETURNDATE); }
    static removeSomeoneAffliation() { return window.sessionStorage.removeItem(SESSION_KEY_SOMEONEAFFLIATION); }
    static removeSomeoneEmail() { return window.sessionStorage.removeItem(SESSION_KEY_SOMEONEEMAIL); }
    static removeSomeoneName() { return window.sessionStorage.removeItem(SESSION_KEY_SOMEONENAME); }
    static removeSplit1() { return window.sessionStorage.removeItem(SESSION_KEY_SPLIT1); }
    static removeSplit2() { return window.sessionStorage.removeItem(SESSION_KEY_SPLIT2); }
    static removeStatus() { return window.sessionStorage.removeItem(SESSION_KEY_STATUS); }
    static removeSubmit_date() { return window.sessionStorage.removeItem(SESSION_KEY_SUBMIT_DATE); }
    static removeTrain() { return window.sessionStorage.removeItem(SESSION_KEY_TRAIN); }
    static removeTrain_file() { return window.sessionStorage.removeItem(SESSION_KEY_TRAIN_FILE); }
    static removeTravelBefore() { return window.sessionStorage.removeItem(SESSION_KEY_TRAVELBEFORE); }
    static removeTrue_uwnetid() { return window.sessionStorage.removeItem(SESSION_KEY_TRUE_UWNETID); }
    static removeType() { return window.sessionStorage.removeItem(SESSION_KEY_TYPE); }
    static removeUnitID() { return window.sessionStorage.removeItem(SESSION_KEY_UNITID); }
    static removeUS() { return window.sessionStorage.removeItem(SESSION_KEY_US); }
    static removeUser_AccessLevel() { return window.sessionStorage.removeItem(SESSION_KEY_USER_ACCESSLEVEL); }
    static removeUser_email() { return window.sessionStorage.removeItem(SESSION_KEY_USER_EMAIL); }
    static removeUser_id() { return window.sessionStorage.removeItem(SESSION_KEY_USER_ID); }
    static removeUser_name() { return window.sessionStorage.removeItem(SESSION_KEY_USER_NAME); }
    static removeUser_subunitName() { return window.sessionStorage.removeItem(SESSION_KEY_USER_SUBUNITNAME); }
    static removeUser_uwid() { return window.sessionStorage.removeItem(SESSION_KEY_USER_UWID); }
    static removeUwid() { return window.sessionStorage.removeItem(SESSION_KEY_UWID); }
    static removeUwnetid() { return window.sessionStorage.removeItem(SESSION_KEY_UWNETID); }
    static removeVerified_user() { return window.sessionStorage.removeItem(SESSION_KEY_VERIFIED_USER); }
    static removeVisa_file() { return window.sessionStorage.removeItem(SESSION_KEY_VISA_FILE); }
