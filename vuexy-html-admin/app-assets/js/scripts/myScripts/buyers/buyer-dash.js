...
function update_Dashboard_welcomebar_navigationbar() {
    ...
    //adding unit name
    document.getElementById("welcome-unitName").innerHTML = '<i class="feather icon-map-pin"></i> ' + EngineUI.getUnitName();
...
function genPendingRequestCard(request_id, requester, type, date) {
    ...
    console.log(type);
    if(type.localeCompare(EngineUI.ORDER_TYPE_TRAVEL_REQUEST)==0 || type.localeCompare(EngineUI.ORDER_TYPE_TRAVEL_REIMBURSEMENT)==0){
